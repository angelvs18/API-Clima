...
import 'package:font_awesome_flutter/font_awesome_flutter.dart'; // Importa el paquete Font Awesome
...
class WeatherPageState extends State<WeatherPage> {
  ...
  final String _apiKey = '750eeb09eb064a21cc8cf173cb8b5d17'; // Reemplaza con tu propia API key de OpenWeatherMap
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _visibility = (jsonResponse['visibility'] / 1000).toString(); // Convertir visibilidad a kilómetros
          _isLoading = false;
        });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        color: Colors.lightBlue[100], // Fondo azul claro suave
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            // Icono de sol con nubes
            FaIcon(
